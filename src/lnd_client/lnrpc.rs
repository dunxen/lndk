...
pub mod channel_close_summary {
    ...
    impl ClosureType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ClosureType::CooperativeClose => "COOPERATIVE_CLOSE",
                ClosureType::LocalForceClose => "LOCAL_FORCE_CLOSE",
                ClosureType::RemoteForceClose => "REMOTE_FORCE_CLOSE",
                ClosureType::BreachClose => "BREACH_CLOSE",
                ClosureType::FundingCanceled => "FUNDING_CANCELED",
                ClosureType::Abandoned => "ABANDONED",
            }
        }
...
pub mod peer {
    ...
    impl SyncType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                SyncType::UnknownSync => "UNKNOWN_SYNC",
                SyncType::ActiveSync => "ACTIVE_SYNC",
                SyncType::PassiveSync => "PASSIVE_SYNC",
                SyncType::PinnedSync => "PINNED_SYNC",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod peer_event {
    ...
    impl EventType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                EventType::PeerOnline => "PEER_ONLINE",
                EventType::PeerOffline => "PEER_OFFLINE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod pending_channels_response {
    ...
    pub mod force_closed_channel {
        ...
        impl AnchorState {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    AnchorState::Limbo => "LIMBO",
                    AnchorState::Recovered => "RECOVERED",
                    AnchorState::Lost => "LOST",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod channel_event_update {
    ...
    impl UpdateType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                UpdateType::OpenChannel => "OPEN_CHANNEL",
                UpdateType::ClosedChannel => "CLOSED_CHANNEL",
                UpdateType::ActiveChannel => "ACTIVE_CHANNEL",
                UpdateType::InactiveChannel => "INACTIVE_CHANNEL",
                UpdateType::PendingOpenChannel => "PENDING_OPEN_CHANNEL",
                UpdateType::FullyResolvedChannel => "FULLY_RESOLVED_CHANNEL",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl FailureCode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                FailureCode::IncorrectPaymentAmount => "INCORRECT_PAYMENT_AMOUNT",
                FailureCode::FinalIncorrectCltvExpiry => "FINAL_INCORRECT_CLTV_EXPIRY",
                FailureCode::FinalIncorrectHtlcAmount => "FINAL_INCORRECT_HTLC_AMOUNT",
                FailureCode::FinalExpiryTooSoon => "FINAL_EXPIRY_TOO_SOON",
                FailureCode::InvalidRealm => "INVALID_REALM",
                FailureCode::ExpiryTooSoon => "EXPIRY_TOO_SOON",
                FailureCode::InvalidOnionVersion => "INVALID_ONION_VERSION",
                FailureCode::InvalidOnionHmac => "INVALID_ONION_HMAC",
                FailureCode::InvalidOnionKey => "INVALID_ONION_KEY",
                FailureCode::AmountBelowMinimum => "AMOUNT_BELOW_MINIMUM",
                FailureCode::FeeInsufficient => "FEE_INSUFFICIENT",
                FailureCode::IncorrectCltvExpiry => "INCORRECT_CLTV_EXPIRY",
                FailureCode::ChannelDisabled => "CHANNEL_DISABLED",
                FailureCode::TemporaryChannelFailure => "TEMPORARY_CHANNEL_FAILURE",
                FailureCode::RequiredNodeFeatureMissing => {
                    "REQUIRED_NODE_FEATURE_MISSING"
                }
                FailureCode::RequiredChannelFeatureMissing => {
                    "REQUIRED_CHANNEL_FEATURE_MISSING"
                }
                FailureCode::UnknownNextPeer => "UNKNOWN_NEXT_PEER",
                FailureCode::TemporaryNodeFailure => "TEMPORARY_NODE_FAILURE",
                FailureCode::PermanentNodeFailure => "PERMANENT_NODE_FAILURE",
                FailureCode::PermanentChannelFailure => "PERMANENT_CHANNEL_FAILURE",
                FailureCode::ExpiryTooFar => "EXPIRY_TOO_FAR",
                FailureCode::MppTimeout => "MPP_TIMEOUT",
                FailureCode::InvalidOnionPayload => "INVALID_ONION_PAYLOAD",
                FailureCode::InternalFailure => "INTERNAL_FAILURE",
                FailureCode::UnknownFailure => "UNKNOWN_FAILURE",
                FailureCode::UnreadableFailure => "UNREADABLE_FAILURE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl OutputScriptType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            OutputScriptType::ScriptTypePubkeyHash => "SCRIPT_TYPE_PUBKEY_HASH",
            OutputScriptType::ScriptTypeScriptHash => "SCRIPT_TYPE_SCRIPT_HASH",
            ...
            OutputScriptType::ScriptTypePubkey => "SCRIPT_TYPE_PUBKEY",
            OutputScriptType::ScriptTypeMultisig => "SCRIPT_TYPE_MULTISIG",
            OutputScriptType::ScriptTypeNulldata => "SCRIPT_TYPE_NULLDATA",
            OutputScriptType::ScriptTypeNonStandard => "SCRIPT_TYPE_NON_STANDARD",
            OutputScriptType::ScriptTypeWitnessUnknown => "SCRIPT_TYPE_WITNESS_UNKNOWN",
...
impl AddressType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            AddressType::WitnessPubkeyHash => "WITNESS_PUBKEY_HASH",
            AddressType::NestedPubkeyHash => "NESTED_PUBKEY_HASH",
            AddressType::UnusedWitnessPubkeyHash => "UNUSED_WITNESS_PUBKEY_HASH",
            AddressType::UnusedNestedPubkeyHash => "UNUSED_NESTED_PUBKEY_HASH",
            AddressType::TaprootPubkey => "TAPROOT_PUBKEY",
            AddressType::UnusedTaprootPubkey => "UNUSED_TAPROOT_PUBKEY",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl Initiator {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Initiator::Unknown => "INITIATOR_UNKNOWN",
            Initiator::Local => "INITIATOR_LOCAL",
            Initiator::Remote => "INITIATOR_REMOTE",
            Initiator::Both => "INITIATOR_BOTH",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ResolutionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ResolutionType::TypeUnknown => "TYPE_UNKNOWN",
            ResolutionType::Anchor => "ANCHOR",
            ResolutionType::IncomingHtlc => "INCOMING_HTLC",
            ResolutionType::OutgoingHtlc => "OUTGOING_HTLC",
...
impl NodeMetricType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            NodeMetricType::BetweennessCentrality => "BETWEENNESS_CENTRALITY",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl PaymentFailureReason {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            PaymentFailureReason::FailureReasonNone => "FAILURE_REASON_NONE",
            PaymentFailureReason::FailureReasonTimeout => "FAILURE_REASON_TIMEOUT",
            PaymentFailureReason::FailureReasonNoRoute => "FAILURE_REASON_NO_ROUTE",
            PaymentFailureReason::FailureReasonError => "FAILURE_REASON_ERROR",
...
impl FeatureBit {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            FeatureBit::DatalossProtectReq => "DATALOSS_PROTECT_REQ",
            FeatureBit::DatalossProtectOpt => "DATALOSS_PROTECT_OPT",
            FeatureBit::InitialRouingSync => "INITIAL_ROUING_SYNC",
            FeatureBit::UpfrontShutdownScriptReq => "UPFRONT_SHUTDOWN_SCRIPT_REQ",
            FeatureBit::UpfrontShutdownScriptOpt => "UPFRONT_SHUTDOWN_SCRIPT_OPT",
            FeatureBit::GossipQueriesReq => "GOSSIP_QUERIES_REQ",
            FeatureBit::GossipQueriesOpt => "GOSSIP_QUERIES_OPT",
            FeatureBit::TlvOnionReq => "TLV_ONION_REQ",
            FeatureBit::TlvOnionOpt => "TLV_ONION_OPT",
            FeatureBit::ExtGossipQueriesReq => "EXT_GOSSIP_QUERIES_REQ",
            FeatureBit::ExtGossipQueriesOpt => "EXT_GOSSIP_QUERIES_OPT",
            FeatureBit::StaticRemoteKeyReq => "STATIC_REMOTE_KEY_REQ",
            FeatureBit::StaticRemoteKeyOpt => "STATIC_REMOTE_KEY_OPT",
            FeatureBit::PaymentAddrReq => "PAYMENT_ADDR_REQ",
            FeatureBit::PaymentAddrOpt => "PAYMENT_ADDR_OPT",
            FeatureBit::MppReq => "MPP_REQ",
            FeatureBit::MppOpt => "MPP_OPT",
            FeatureBit::WumboChannelsReq => "WUMBO_CHANNELS_REQ",
            FeatureBit::WumboChannelsOpt => "WUMBO_CHANNELS_OPT",
            FeatureBit::AnchorsReq => "ANCHORS_REQ",
            FeatureBit::AnchorsOpt => "ANCHORS_OPT",
            FeatureBit::AnchorsZeroFeeHtlcReq => "ANCHORS_ZERO_FEE_HTLC_REQ",
            FeatureBit::AnchorsZeroFeeHtlcOpt => "ANCHORS_ZERO_FEE_HTLC_OPT",
            FeatureBit::AmpReq => "AMP_REQ",
            FeatureBit::AmpOpt => "AMP_OPT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl UpdateFailure {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            UpdateFailure::Unknown => "UPDATE_FAILURE_UNKNOWN",
            UpdateFailure::Pending => "UPDATE_FAILURE_PENDING",
            UpdateFailure::NotFound => "UPDATE_FAILURE_NOT_FOUND",
            UpdateFailure::InternalErr => "UPDATE_FAILURE_INTERNAL_ERR",
            UpdateFailure::InvalidParameter => "UPDATE_FAILURE_INVALID_PARAMETER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
